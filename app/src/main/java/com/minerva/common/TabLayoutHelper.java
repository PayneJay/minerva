    ...
    private void initListener(TabLayout tabLayout) {
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (builder.getSelectedTextSize() != 0) {
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, builder.getSelectedTextSize());
                }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                if (builder.getNormalTextSize() != 0) {
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, builder.getNormalTextSize());
                }
